...
export const Singup = () => {
  ...
  return (
    ...
    <div className="flex w-[100%] justify-center  text-[25px] lg:text-[40px] lg:h-[58px] lg:w-[528px] font-[600]">Welcome to<div className="text-[#4534AC]">&nbsp;Project Tracking </div></div>
