...
const statushandler=()=>{
  ...
  return (
   <div className='flex mt-2 w-screen h-fit justify-center'>
    ...
    <div className="flex w-[50%] items-center text-blue-700  pl-[10%] h-[100%] font-extrabold text-[20px] lg:text-[25px] animate-pulse lg:animate-bounce " >Project Tracking</div>
